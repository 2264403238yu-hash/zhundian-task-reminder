(() => {
  ...
  async function toggleTask(taskId) {
    ...
    if (task.completed) {
      ...
      if (nextTask) state.tasks.push(nextTask);
  ...
  async function handleTaskListClick(event) {
    ...
    if (action === 'calendar' && task) downloadTaskCalendar(task);
  ...
  function bindEvents() {
    ...
    [elements.taskDialog, elements.settingsDialog, elements.reminderDialog].forEach((dialog) => {
